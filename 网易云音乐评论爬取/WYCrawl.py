...
# 完美兼容win10、python3.6，由于python3.6下pycrypto库已经停止维护，可以安装pyCryptodome库代替，pyCyrpto库的后续分支，有一个叫pyCryptodome的库，是前代的延伸版。
import sys
import codecs
...
def main():
    idPs = ['25727803']#['557581284','32019002']   #花粥《纸短情长》以及Zedd / Jon Bellion的《beautiful now》，可根据需要在网易云音乐查找歌曲ID后替换，列表元素越多，爬取的循环次数越多
