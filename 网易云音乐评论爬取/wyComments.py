...
class Spider():
    ...
    def json2list(self,jsons):
        ...
        for user in users['comments']:
            ...
            for contents in list(user_dict.values()):
...
def main():
    idPs = ['1293886117']#['557581284','32019002']   #花粥《纸短情长》以及Zedd / Jon Bellion的《beautiful now》，可根据需要在网易云音乐查找歌曲ID后替换，列表元素越多，爬取的循环次数越多
